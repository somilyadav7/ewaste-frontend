          ...
          <table className="table-auto w-full">
            <thead>
              <tr>
                ...
                <th className="px-4 py-2 bg-gray-200">Address</th> {/* Address column */}
                <th className="px-4 py-2 bg-gray-200">Image</th> {/* New Image column */}
            ...
            <tbody>
              {this.state.orders.map((order) => (
                <tr key={order._id}>
                  ...
                  <td className="border px-4 py-2">{order.location}</td> {/* Address field */}

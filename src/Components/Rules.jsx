    ...
    <>
      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="mb-4">
          ...
          <p className="text-lg mb-4">Subject: The E-Waste (Management) Rules, 2022</p>
        ...
        <div className="mb-6">
          ...
          <p className="text-base mb-2 font-bold">2. Definitions.</p>
          <p className="text-base mb-4">
            In these rules, unless the context otherwise requires,-
          </p>
          <ul className="list-disc ml-8 mb-4">
            <li className="mb-2">
              <strong>(a) "Act"</strong> means the Environment (Protection) Act, 1986 (29 of
              1986);
            </li>
            <li className="mb-2">
              <strong>(b) "Appliance"</strong> means any electrical or electronic equipment that
              is designed for household use;
            </li>
            <li className="mb-2">
              <strong>(c) "Authorized dismantler"</strong> means a person or entity authorized by
        ...
        <div className="mb-6">
          ...
          <p className="text-base mb-2 font-bold">4. Collection of E-Waste from Consumers.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">5. Recycling Targets.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">6. Labeling of Electronic Products.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">7. Annual Reporting.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">8. Transportation and Handling of E-Waste.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">9. Awareness Programs.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">10. Prohibition of Unauthorized Handling.</p>
          <p className="text-base mb-4 ml-4">
          ...
          <p className="text-base mb-2 font-bold">11. Collaboration with Authorized Treatment and Disposal Facilities.</p>
          <p className="text-base mb-4 ml-4">
